...
| --- | --- | --- |
| 1. Architecture | [Network architecture](01-architecture/network-architecture.md) · [Asset inventory](01-architecture/asset-inventory.md) · [Diagram](01-architecture/Meridian_Vault_Financial-4.Network%20Architecture%20Design.drawio.png) | System roles, network layout, constraints, and intended security model. |
| 2. Implementation and data collection | [Four-machine evidence appendix](02-implementation-data-collection/4%20machines%20setup/4-machine-implementation-evidence.md) · [Splunk setup](02-implementation-data-collection/siem-log-forwarding/splunk-server-setup.md) · [Windows forwarding](02-implementation-data-collection/siem-log-forwarding/windows-log-forwarding.md) · [Linux forwarding](02-implementation-data-collection/siem-log-forwarding/linux-log-forwarding.md) · [Pipeline verification](02-implementation-data-collection/siem-log-forwarding/pipeline-verification.md) | Deployment evidence, Windows/Sysmon and Linux/application log inputs, and checks that events reach Splunk. |
| 3. Detection engineering | [Detections](03-detection-engineering/detections.md) · [Dashboards](03-detection-engineering/dashboards.md) | SPL searches for suspicious PowerShell, Run key changes, and failed logins; dashboard panels for authentication, firewall, alert, and network activity. |
| 4. Investigations | [LSASS alert triage](04-investigations/T1003.001-lsass-credential-dumping-alert-triage/README.md) · [Full LSASS investigation](04-investigations/T1003.001-lsass-credential-dumping-alert-triage/investigation-full.md) · [Tempest case study](04-investigations/IncidentInvestigation_Tempest.docx.md) | A lab alert investigated with Sysmon and filesystem evidence, plus a separate TryHackMe case study reconstructing an attack chain. |
...
04-investigations/                    LSASS alert triage and Tempest case study
