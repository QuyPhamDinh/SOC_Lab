...
![alt text](dns-exfiltration-media/alert-triggered.png)
...
![alt text](dns-exfiltration-media/dns-base-exfiltration.png)
...
![alt text](dns-exfiltration-media/sesitive-data-collected.png)
...
```
![alt text](dns-exfiltration-media/scope.png)
