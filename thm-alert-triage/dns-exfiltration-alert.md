...
![alt text](dns-exfiltration-alert/alert-triggered.png)
...
![alt text](dns-exfiltration-alert/dns-base-exfiltration.png)
...
![alt text](dns-exfiltration-alert/sesitive-data-collected.png)
...
```
![alt text](dns-exfiltration-alert/scope.png)
